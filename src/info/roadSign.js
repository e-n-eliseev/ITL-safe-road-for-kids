...
export const roadSign = [
    ...
    { pic: `${bikePath}`, name: "Велосипедная дорожка", desc: "Голубой круг с рисунком велосипеда. Значит на этом промежутке дороги, безопасно кататься и учиться кататься на велосипеде.", additional: "По велосипедной дорожке могут двигаться также пешеходы(при отсутствии тротуара или пешеходной дорожки)." },
    ...
    { pic: `${footPath}`, name: "Пешеходная дорожка", desc: "Голубой знак, в виде круга с нарисованным человечком. Значит, что этот промежуток дороги только для пешеходов.", additional: "Знак применяется для обозначения дорожек, предназначенных только для пешеходов" },
    { pic: `${kids}`, name: "Дети", desc: "Внутри знака нарисованы бегущие детки. Обычно эти знаки располагают рядом с детскими учреждениями, например школы, детские сады, лагерь и т.д.", additional: "Указывает водителю, что следует снизить скорость, повысить внимание, так как действия детей неосознаны и не предсказуемы." },
